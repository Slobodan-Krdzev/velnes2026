...
Locator: locator('tr').filter({ hasText: 'Studio Nova mugt46yl' }).getByText('Awaiting SMTP')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('tr').filter({ hasText: 'Studio Nova mugt46yl' }).getByText('Awaiting SMTP')
