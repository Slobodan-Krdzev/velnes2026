  ...
  return (
    <div className="gps-modal" role="dialog" aria-modal="true" aria-labelledby="gps-title">
      <div className="gps-card">
        ...
        <h2 id="gps-title">Find what&rsquo;s near you</h2>
        <p>
          Velnes uses your location to show available salons and treatments close to
          you. We never store or share your location.
        </p>
